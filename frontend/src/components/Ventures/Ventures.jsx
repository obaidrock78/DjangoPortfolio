...
const flagships = [
  {
    ...
    cta:  { label: "Explore FANN →", href: "https://app.fann.art" },
  },
  {
    ...
    categories: ["Social", "Web3", "AI/ML"],
    description:
      "VIKO World is a next-generation social platform where users own their identity, content, and connections on-chain. I lead the full product — from the decentralised identity layer and smart contract infrastructure to the React frontend and the AI-driven personalisation engine that makes every feed uniquely yours.",
    role:     "Founder & Lead Engineer",
    period:   "2024 – Present",
    location: "Remote · Global",
    highlights: [
      "Architected a decentralised identity system giving users full sovereignty over their data",
      "Built on-chain social graph contracts enabling verifiable connections across chains",
      "Integrated AI personalisation layer delivering contextually relevant content at scale",
    ],
    tech: ["React", "Solidity", "Node.js", "IPFS", "Python", "AI/ML", "Web3", "PostgreSQL"],
    cta:  { label: "Explore VIKO World →", href: "https://viko.world" },
  },
];
